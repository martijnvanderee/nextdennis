    ...
    <div className="relative">
      ...
      <div className="content-container">
        ...
        <div className="">
          ...
          <div className="mt-8">
            <h3 className="text-xl md:text-2xl text-headingColor">
              Boeken die mij geïnspireerd hebben
            </h3>

            <h4 className="text-lg font-bold text-headingColor">
              Over onderwijs:
            </h4>
            ...
            <h4 className="text-lg mt-4 font-bold text-headerColor ">
